...
const config: Config = {
  ...
  tagline: 'Learn the fundamentals of physical AI and humanoid robotics.',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/your-organization/textbook-platform/tree/main/frontend/',
        },
        blog: {
